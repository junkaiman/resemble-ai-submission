...
export default function MainContent() {
  ...
  const [selectedVoiceId, setSelectedVoiceId] = React.useState<number>(0);
      ...
      <div>
        ...
        <div className="flex justify-end gap-2 py-2 items-center">
          ...
          <button
            ...
            disabled={loading}
            className="flex flex-row gap-1 items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            {loading && (
              <svg
                aria-hidden="true"
